...
def get_main_agent_prompt(response_mode: str = "user") -> str:
    ...
    base = (
        ...
        "How to work:\n"
        "1. Read the request and decide whether you need more context. If not, respond directly.\n"
        "2. If you need internal context, use query_internal_knowledge with a focused question.\n"
        "3. If the issue likely involves another service, call discover_services and then "
        "get_service_report with a concise request that includes only the needed context or log.\n"
        "4. After tool responses, decide if any follow-up context is needed. Otherwise respond.\n\n"
        "Responses:\n"
